...
/** Home mobile categories rail — Figma marco mobile2 node 213:2960. */
export const HOME_CATEGORIES_CARD_WIDTH_PX = 138;
export const HOME_CATEGORIES_CARD_HEIGHT_PX = 107;
export const HOME_CATEGORIES_CARD_RADIUS_PX = 20;
export const HOME_CATEGORIES_CARD_GAP_PX = 10;
export const HOME_CATEGORIES_TITLE_TO_RAIL_GAP_PX = 20;
export const HOME_CATEGORIES_AFTER_HERO_GAP_PX = 28;
export const HOME_CATEGORIES_SCROLL_EDGE_PX = 2;
